 ...
 * Run with: make bench DIR=problems/<platform>/<slug>   (or: npx ts-node benchmark.ts)
 */
...
type Args = Parameters<typeof solve>;

// TODO: return the arguments for solve() as a tuple, for an input of size n
...
function makeInput(n: number): Args {
  void n;
  return [];
}
